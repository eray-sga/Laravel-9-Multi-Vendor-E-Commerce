                                ...
                                <table id="sections" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($section['status']==1)
                                                   <a class="updateSectionStatus" id="section-{{$section['id']}}" section_id="{{$section['id']}}" href="javascript:void(0)" ><i status="Active" style="font-size: 25px" class="mdi mdi-bookmark-check"></i></a>
                                                @else 
                                                    <a class="updateSectionStatus" id="section-{{$section['id']}}" section_id="{{$section['id']}}" href="javascript:void(0)" ><i status="Inactive" style="font-size: 25px" class="mdi mdi-bookmark-outline"></i></a>
                                                @endif
